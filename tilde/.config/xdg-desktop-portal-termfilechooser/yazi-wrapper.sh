...
# Source: https://github.com/boydaihungst/xdg-desktop-portal-termfilechooser/blob/main/contrib/yazi-wrapper.sh
# -> adapted to ghostty terminal
...
# termcmd="${TERMCMD:-/usr/bin/ghostty --title=$(quote_string "$TITLE")}" 
# dont use default.. -> can add title:
termcmd="/usr/bin/ghostty --class='com.lmnk.termfilechooser' --title=$(quote_string "$TITLE")"
...
' >"$path"
  ...
  # Use this if you want to select folder by enter a.k.a yazi keybind for 'open' funtion ('run = "open") .
